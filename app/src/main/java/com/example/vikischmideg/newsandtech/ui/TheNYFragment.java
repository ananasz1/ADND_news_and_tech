...
public class TheNYFragment extends Fragment implements NewsAdapter.OnArticleClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public TheNYFragment() {
    }

    public static TheNYFragment newInstance() {
        TheNYFragment theNYFragment = new TheNYFragment();

        return theNYFragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        source = getString(R.string.source_tnyt);
