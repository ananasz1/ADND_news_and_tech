...
public class TechRadarFragment extends Fragment implements NewsAdapter.OnArticleClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public TechRadarFragment() {
    }

    public static TechRadarFragment newInstance() {
        TechRadarFragment techRadarFragment = new TechRadarFragment();

        return techRadarFragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        source = getString(R.string.source_techradar);
    ...
    private void loadArticles() {
        ...
        final Call<Article> articleCall = articleParsing.getHeadlines(source, "en",
