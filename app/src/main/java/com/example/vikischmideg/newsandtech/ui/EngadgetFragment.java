...
public class EngadgetFragment extends Fragment implements NewsAdapter.OnArticleClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public EngadgetFragment() {
    }

    public static EngadgetFragment newInstance() {
        EngadgetFragment engadgetFragment = new EngadgetFragment();

        return engadgetFragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        source = getString(R.string.source_engadget);
