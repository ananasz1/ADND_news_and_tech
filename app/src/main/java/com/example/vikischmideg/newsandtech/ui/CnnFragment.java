...
public class CnnFragment extends Fragment implements NewsAdapter.OnArticleClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        source = getString(R.string.source_cnn);
